                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                <a v-bind:href="'/dummy/' + row.Id">{{row.Name}}</a>
                            </td>
                            <td>
                                {{row.Created }}
                            </td>
                            <td ><a v-bind:href="'/dummy/' + row.Id + '/edit'">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadData: function (){
                $.getJSON('api/dummy-data', function (data) {
                    ...
                    this.first_page_url = 'api/dummy-data?page=1';
                    this.last_page_url = 'api/dummy-data?page=' + this.last_page;
                    this.setPageNumbers();
                }.bind(this));
            },
                ...
                if (this.query == '' && getPage != null){
                    ...
                    if (getPage != null){
                        ...
                        $.getJSON(getPage, function (data) {
                            ...
                            this.first_page_url = 'api/dummy-data?page=1&keyword=' +this.query;
                            this.last_page_url = 'api/dummy-data?page=' + this.last_page + '&keyword=' +this.query;
                            this.current_page = data.current_page;
