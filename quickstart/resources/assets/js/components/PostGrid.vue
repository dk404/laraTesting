                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                <a v-bind:href="'/post/' + row.Id+ '-' + row.Slug">{{row.Name}}</a>
                            </td>
                            <td>
                                {{showPublished(row.Published)}}
                            </td>
                            <td>
                                {{row.Created }}
                            </td>
                            <td ><a v-bind:href="'/post/' + row.Id + '/edit'">
    ...
    export default {
        ...
        data: function () {
            ...
            return {
                ...
                query: '',
                gridColumns: ['Id', 'Name', 'Published', 'Created'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
        ...
        methods: {
            ...
            showPublished:  function (Published){

                return Published == 1 ? 'Published' : 'Draft';
            },

            loadData: function (){
                $.getJSON('api/post-data', function (data) {
                    ...
                    this.first_page_url = 'api/post-data?page=1';
                    this.last_page_url = 'api/post-data?page=' + this.last_page;
                    this.setPageNumbers();
                }.bind(this));
            },
                ...
                if (this.query == '' && getPage != null){
                    ...
                    if (getPage != null){
                        ...
                        $.getJSON(getPage, function (data) {
                            ...
                            this.first_page_url = 'api/post-data?page=1&keyword=' +this.query;
                            this.last_page_url = 'api/post-data?page=' + this.last_page + '&keyword=' +this.query;
                            this.current_page = data.current_page;
